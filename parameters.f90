...
!integer, parameter :: nb = 1681

double precision, parameter :: pi 	   = 3.14159265358979d0
double precision, parameter :: alpha 	   = 0d0 !3.13d0
double precision, parameter :: gamma 	   = 0.78d0 !(2d0 * pi) / alpha
double precision, parameter :: eta 	   = 0.7d0
double precision, parameter :: Q	   = 0d0
double precision, parameter :: Re1 	   = 500d0
...
integer, 	  parameter :: save_rate_2 = 92
...
!****************************************************************************
integer, parameter :: nb = (nx+1)*(nz+1)
