...
double precision, parameter :: alpha 	   = 3.13d0 * 0.5d0
...
double precision, parameter :: end_time    = 4000d0
...
integer, 	  parameter :: save_rate_2 = 108
...
double precision, parameter :: eps1	   = 0.0d0 * Re1
double precision, parameter :: freq1	   = 0d0
