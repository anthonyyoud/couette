...
do k = 1, nz-1
   ...
   fz(1:nx-1,0) = -f(1:nx1,2) + 4d0 * f(1:nx1,1) - 3d0 * f(1:nx1,0)
   fz(1:nx-1,nz) = f(1:nx1,nz-2) - 4d0 * f(1:nx1,nz1) + 3d0 * &
                   f(1:nx1,nz)
end do
...
do k = 1, nz-1
   ...
   fzz(1:nx-1,0) = -f(1:nx1,3) + 4d0 * f(1:nx1,2) - &
                    5d0 * f(1:nx1,1) + 2d0 * f(1:nx1,0)
   fzz(1:nx-1,nz) = -f(1:nx1,nz-3) + 4d0 * f(1:nx1,nz-2) - &
